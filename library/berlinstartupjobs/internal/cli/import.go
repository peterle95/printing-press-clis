...
but do not stop the import.`,
  ...
  berlinstartupjobs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  berlinstartupjobs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | berlinstartupjobs-pp-cli import <resource> --input -`,
