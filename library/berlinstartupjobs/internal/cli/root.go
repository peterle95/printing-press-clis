...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "berlinstartupjobs-pp-cli",
		Short: "Manage berlinstartupjobs resources via the berlinstartupjobs API",
		Long: `Manage berlinstartupjobs resources via the berlinstartupjobs API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'berlinstartupjobs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("berlinstartupjobs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'berlinstartupjobs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newSkillAreasPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("berlinstartupjobs-pp-cli %s\n", version)
		},
	}
}
