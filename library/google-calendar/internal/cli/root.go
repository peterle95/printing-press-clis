...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "google-calendar-pp-cli",
		Short: "Manage google-calendar resources via the google-calendar API",
		Long: `Manage google-calendar resources via the google-calendar API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'google-calendar-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("google-calendar-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'google-calendar-pp-cli profile list')")
	...
	rootCmd.AddCommand(newChannelsPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("google-calendar-pp-cli %s\n", version)
		},
	}
}
