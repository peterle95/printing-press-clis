...
Exit codes & warnings:
  ...
  google-calendar-pp-cli sync

  # Sync specific resources only
  google-calendar-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  google-calendar-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  google-calendar-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  google-calendar-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  google-calendar-pp-cli sync --latest-only`,
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/google-calendar-pp-cli/data.db)")
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"users":                  "/users/me/settings",
		"users-me-calendar-list": "/users/me/calendarList",
	}
