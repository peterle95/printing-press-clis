...
but do not stop the import.`,
  ...
  google-calendar-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  google-calendar-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | google-calendar-pp-cli import <resource> --input -`,
