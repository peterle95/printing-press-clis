...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  google-calendar-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  google-calendar-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"users", "users-me-calendar-list"}
			totalSynced := 0
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  google-calendar-pp-cli workflow status

  # Show status as JSON
  google-calendar-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("google-calendar-pp-cli")
			}
