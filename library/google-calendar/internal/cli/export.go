...
large datasets as it has no memory pressure.`,
  ...
  google-calendar-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  google-calendar-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  google-calendar-pp-cli export <resource> --format jsonl | jq '.id'`,
