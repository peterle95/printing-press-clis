...
native streaming instead of polling.`,
  ...
  google-calendar-pp-cli tail --interval 10s

  # Tail a specific resource
  google-calendar-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  google-calendar-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
