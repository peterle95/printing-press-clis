...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "linkedin-pp-cli",
		Short: "Manage linkedin resources via the linkedin API",
		Long: `Manage linkedin resources via the linkedin API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'linkedin-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("linkedin-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'linkedin-pp-cli profile list')")
