...
but do not stop the import.`,
  ...
  linkedin-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  linkedin-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | linkedin-pp-cli import <resource> --input -`,
