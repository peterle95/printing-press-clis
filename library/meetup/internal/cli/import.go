...
but do not stop the import.`,
  ...
  meetup-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  meetup-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | meetup-pp-cli import <resource> --input -`,
