...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "meetup-pp-cli",
		Short: "Manage meetup resources via the meetup API",
		Long: `Manage meetup resources via the meetup API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'meetup-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("meetup-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'meetup-pp-cli profile list')")
	...
	rootCmd.AddCommand(newFindEventsCmd(flags))
	rootCmd.AddCommand(newGqlExtPromotedCmd(flags))
