...
large datasets as it has no memory pressure.`,
  ...
  germantechjobs-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  germantechjobs-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  germantechjobs-pp-cli export <resource> --format jsonl | jq '.id'`,
