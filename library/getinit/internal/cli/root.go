...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "getinit-pp-cli",
		Short: "Manage getinit resources via the getinit API",
		Long: `Manage getinit resources via the getinit API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'getinit-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("getinit-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'getinit-pp-cli profile list')")
	...
	rootCmd.AddCommand(newJobsuchePromotedCmd(flags))
