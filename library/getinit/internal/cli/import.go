...
but do not stop the import.`,
  ...
  getinit-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  getinit-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | getinit-pp-cli import <resource> --input -`,
