...
but do not stop the import.`,
  ...
  englishjobs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  englishjobs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | englishjobs-pp-cli import <resource> --input -`,
