...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "englishjobs-pp-cli",
		Short: "Manage englishjobs resources via the englishjobs API",
		Long: `Manage englishjobs resources via the englishjobs API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'englishjobs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("englishjobs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'englishjobs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newInLocationPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("englishjobs-pp-cli %s\n", version)
		},
	}
}
