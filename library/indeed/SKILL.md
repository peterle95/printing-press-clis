---
name: pp-indeed
description: "Printing Press CLI for Indeed. Indeed robots/search reachability checker. Search pages may return 403 from this environment."
...
**indeed-public-surface-jobs** — Manage indeed public surface jobs

- `indeed-pp-cli indeed-public-surface-jobs` — Probe Indeed public jobs search

**robots-txt** — Manage robots txt

- `indeed-pp-cli robots-txt` — Fetch Indeed robots.txt
...
- **Filterable** — `--select` keeps a subset of fields. Dotted paths descend into nested structures; arrays traverse element-wise. Critical for keeping context small on verbose APIs:
  ...
  ```bash
  indeed-pp-cli indeed-public-surface-jobs --agent --select id,name,status
  ```
...
indeed-pp-cli --profile briefing indeed-public-surface-jobs
