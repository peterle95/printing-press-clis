...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "indeed-pp-cli",
		Short: "Manage indeed resources via the indeed API",
		Long: `Manage indeed resources via the indeed API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'indeed-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("indeed-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'indeed-pp-cli profile list')")
	...
	rootCmd.AddCommand(newIndeedPublicSurfaceJobsPromotedCmd(flags))
	rootCmd.AddCommand(newRobotsTxtPromotedCmd(flags))
