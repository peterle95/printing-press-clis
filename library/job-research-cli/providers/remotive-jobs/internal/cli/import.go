...
but do not stop the import.`,
  ...
  remotive-jobs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  remotive-jobs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | remotive-jobs-pp-cli import <resource> --input -`,
