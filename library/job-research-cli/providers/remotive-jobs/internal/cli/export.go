...
large datasets as it has no memory pressure.`,
  ...
  remotive-jobs-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  remotive-jobs-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  remotive-jobs-pp-cli export <resource> --format jsonl | jq '.id'`,
