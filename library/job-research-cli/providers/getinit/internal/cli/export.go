...
large datasets as it has no memory pressure.`,
  ...
  getinit-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  getinit-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  getinit-pp-cli export <resource> --format jsonl | jq '.id'`,
