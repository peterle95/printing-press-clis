...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "germantechjobs-pp-cli",
		Short: "Manage germantechjobs resources via the germantechjobs API",
		Long: `Manage germantechjobs resources via the germantechjobs API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'germantechjobs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("germantechjobs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'germantechjobs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newRssPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("germantechjobs-pp-cli %s\n", version)
		},
	}
}
