...
but do not stop the import.`,
  ...
  germantechjobs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  germantechjobs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | germantechjobs-pp-cli import <resource> --input -`,
