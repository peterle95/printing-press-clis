...
but do not stop the import.`,
  ...
  stepstone-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  stepstone-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | stepstone-pp-cli import <resource> --input -`,
