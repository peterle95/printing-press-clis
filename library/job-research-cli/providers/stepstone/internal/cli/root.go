...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "stepstone-pp-cli",
		Short: "Manage stepstone resources via the stepstone API",
		Long: `Manage stepstone resources via the stepstone API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'stepstone-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("stepstone-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'stepstone-pp-cli profile list')")
	...
	rootCmd.AddCommand(newInLocationCmd(flags))
