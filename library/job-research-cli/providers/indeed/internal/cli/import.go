...
but do not stop the import.`,
  ...
  indeed-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  indeed-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | indeed-pp-cli import <resource> --input -`,
