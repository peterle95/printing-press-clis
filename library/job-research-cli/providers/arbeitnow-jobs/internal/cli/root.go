...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "arbeitnow-jobs-pp-cli",
		Short: "Manage arbeitnow-jobs resources via the arbeitnow-jobs API",
		Long: `Manage arbeitnow-jobs resources via the arbeitnow-jobs API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'arbeitnow-jobs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("arbeitnow-jobs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'arbeitnow-jobs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newJobBoardApiPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("arbeitnow-jobs-pp-cli %s\n", version)
		},
	}
}
