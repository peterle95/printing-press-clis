...
but do not stop the import.`,
  ...
  arbeitnow-jobs-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  arbeitnow-jobs-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | arbeitnow-jobs-pp-cli import <resource> --input -`,
