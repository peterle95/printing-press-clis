...
large datasets as it has no memory pressure.`,
  ...
  arbeitnow-jobs-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  arbeitnow-jobs-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  arbeitnow-jobs-pp-cli export <resource> --format jsonl | jq '.id'`,
