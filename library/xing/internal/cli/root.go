...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "xing-pp-cli",
		Short: "Manage xing resources via the xing API",
		Long: `Manage xing resources via the xing API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'xing-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("xing-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'xing-pp-cli profile list')")
