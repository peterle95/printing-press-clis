...
but do not stop the import.`,
  ...
  doctolib-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  doctolib-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | doctolib-pp-cli import <resource> --input -`,
