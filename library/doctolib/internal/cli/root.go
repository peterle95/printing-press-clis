...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "doctolib-pp-cli",
		Short: "Manage doctolib resources via the doctolib API",
		Long: `Manage doctolib resources via the doctolib API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'doctolib-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("doctolib-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'doctolib-pp-cli profile list')")
	...
	rootCmd.AddCommand(newPatientHealthSearchCmd(flags))
	...
	rootCmd.AddCommand(newDoctolibWebsiteSearchSearchPromotedCmd(flags))
	rootCmd.AddCommand(newFindDoctorsCmd(flags))
