...
large datasets as it has no memory pressure.`,
  ...
  airbnb-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  airbnb-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  airbnb-pp-cli export <resource> --format jsonl | jq '.id'`,
