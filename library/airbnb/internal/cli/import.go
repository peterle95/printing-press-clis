...
but do not stop the import.`,
  ...
  airbnb-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airbnb-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airbnb-pp-cli import <resource> --input -`,
