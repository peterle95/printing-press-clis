...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  remotive-jobs-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  remotive-jobs-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  remotive-jobs-pp-cli workflow status

  # Show status as JSON
  remotive-jobs-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("remotive-jobs-pp-cli")
			}
