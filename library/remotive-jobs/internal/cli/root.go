...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "remotive-jobs-pp-cli",
		Short: "Manage remotive-jobs resources via the remotive-jobs API",
		Long: `Manage remotive-jobs resources via the remotive-jobs API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'remotive-jobs-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("remotive-jobs-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'remotive-jobs-pp-cli profile list')")
	...
	rootCmd.AddCommand(newRemoteJobsPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("remotive-jobs-pp-cli %s\n", version)
		},
	}
}
