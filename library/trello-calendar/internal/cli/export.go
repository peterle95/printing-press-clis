...
large datasets as it has no memory pressure.`,
  ...
  trello-calendar-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  trello-calendar-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  trello-calendar-pp-cli export <resource> --format jsonl | jq '.id'`,
