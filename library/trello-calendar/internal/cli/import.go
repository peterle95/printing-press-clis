...
but do not stop the import.`,
  ...
  trello-calendar-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  trello-calendar-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | trello-calendar-pp-cli import <resource> --input -`,
