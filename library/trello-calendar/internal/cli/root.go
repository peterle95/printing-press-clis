...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "trello-calendar-pp-cli",
		Short: "Manage trello-calendar resources via the trello-calendar API",
		Long: `Manage trello-calendar resources via the trello-calendar API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'trello-calendar-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("trello-calendar-pp-cli {{ .Version }}\n")
	...
	// PATCH: Planner diagnostics are opt-in and always written to stderr.
	rootCmd.PersistentFlags().BoolVar(&flags.verbose, "verbose", false, "Print diagnostic details to stderr")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'trello-calendar-pp-cli profile list')")
	...
	rootCmd.AddCommand(newEnterprisesCmd(flags))
	...
	rootCmd.AddCommand(newPluginsCmd(flags))
	rootCmd.AddCommand(newTokensCmd(flags))
	rootCmd.AddCommand(newTrelloCalendarSearchCmd(flags))
	...
	rootCmd.AddCommand(newBatchPromotedCmd(flags))
	rootCmd.AddCommand(newEmojiPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("trello-calendar-pp-cli %s\n", version)
		},
	}
}
