...
the specified number of days. Useful for identifying forgotten or blocked work.`,
  ...
  trello-calendar-pp-cli stale

  # Find items not updated in 14 days
  trello-calendar-pp-cli stale --days 14

  # Filter by team
  trello-calendar-pp-cli stale --days 7 --team backend

  # Output as JSON
  trello-calendar-pp-cli stale --days 30 --json`,
