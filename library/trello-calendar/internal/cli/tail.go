...
native streaming instead of polling.`,
  ...
  trello-calendar-pp-cli tail --interval 10s

  # Tail a specific resource
  trello-calendar-pp-cli tail messages --interval 5s

  # Pipe to jq for filtering
  trello-calendar-pp-cli tail events --interval 30s | jq 'select(.type == "error")'`,
