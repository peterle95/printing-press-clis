...
Exit codes & warnings:
  ...
  trello-calendar-pp-cli sync

  # Sync specific resources only
  trello-calendar-pp-cli sync --resources channels,messages

  # Full resync (ignore previous checkpoint)
  trello-calendar-pp-cli sync --full

  # Incremental sync: only records from the last 7 days
  trello-calendar-pp-cli sync --since 7d

  # Parallel sync with 8 workers
  trello-calendar-pp-cli sync --concurrency 8

  # Latest-only: refresh head of each resource, no historical backfill
  trello-calendar-pp-cli sync --latest-only`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if dbPath == "" {
				dbPath = defaultDBPath("trello-calendar-pp-cli")
			}
	...
	cmd.Flags().StringVar(&dbPath, "db", "", "Database path (default: ~/.local/share/trello-calendar-pp-cli/data.db)")
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "actions_board":
		return db.UpsertActionsBoard(data)
	case "actions_card":
		return db.UpsertActionsCard(data)
	case "actions_list":
		return db.UpsertActionsList(data)
	case "actions_member":
		return db.UpsertActionsMember(data)
	case "actions_member_creator":
		return db.UpsertActionsMemberCreator(data)
	case "actions_organization":
		return db.UpsertActionsOrganization(data)
	case "reactions":
		return db.UpsertReactions(data)
	case "reactions_summary":
		return db.UpsertReactionsSummary(data)
	case "text":
		return db.UpsertText(data)
	case "applications_compliance":
		return db.UpsertApplicationsCompliance(data)
	case "boards":
		return db.UpsertBoards(data)
	case "boards_actions":
		return db.UpsertBoardsActions(data)
	case "board_plugins":
		return db.UpsertBoardPlugins(data)
	case "boards_board_stars":
		return db.UpsertBoardsBoardStars(data)
	case "calendar_key":
		return db.UpsertCalendarKey(data)
	case "boards_cards":
		return db.UpsertBoardsCards(data)
	case "boards_checklists":
		return db.UpsertBoardsChecklists(data)
	case "boards_custom_fields":
		return db.UpsertBoardsCustomFields(data)
	case "email_key":
		return db.UpsertEmailKey(data)
	case "boards_exports":
		return db.UpsertBoardsExports(data)
	case "id_tags":
		return db.UpsertIdTags(data)
	case "boards_labels":
		return db.UpsertBoardsLabels(data)
	case "boards_lists":
		return db.UpsertBoardsLists(data)
	case "marked_as_viewed":
		return db.UpsertMarkedAsViewed(data)
	case "boards_members":
		return db.UpsertBoardsMembers(data)
	case "boards_memberships":
		return db.UpsertBoardsMemberships(data)
	case "my_prefs":
		return db.UpsertMyPrefs(data)
	case "boards_plugins":
		return db.UpsertBoardsPlugins(data)
	case "cards":
		return db.UpsertCards(data)
	case "cards_actions":
		return db.UpsertCardsActions(data)
	case "attachments":
		return db.UpsertAttachments(data)
	case "cards_board":
		return db.UpsertCardsBoard(data)
	case "check_item":
		return db.UpsertCheckItem(data)
	case "check_item_states":
		return db.UpsertCheckItemStates(data)
	case "checklist":
		return db.UpsertChecklist(data)
	case "cards_checklists":
		return db.UpsertCardsChecklists(data)
	case "custom_field":
		return db.UpsertCustomField(data)
	case "custom_field_items":
		return db.UpsertCustomFieldItems(data)
	case "cards_custom_fields":
		return db.UpsertCardsCustomFields(data)
	case "id_labels":
		return db.UpsertIdLabels(data)
	case "id_members":
		return db.UpsertIdMembers(data)
	case "cards_labels":
		return db.UpsertCardsLabels(data)
	case "cards_list":
		return db.UpsertCardsList(data)
	case "mark_associated_notifications_read":
		return db.UpsertMarkAssociatedNotificationsRead(data)
	case "cards_members":
		return db.UpsertCardsMembers(data)
	case "members_voted":
		return db.UpsertMembersVoted(data)
	case "cards_plugin_data":
		return db.UpsertCardsPluginData(data)
	case "stickers":
		return db.UpsertStickers(data)
	case "checklists_board":
		return db.UpsertChecklistsBoard(data)
	case "checklists_cards":
		return db.UpsertChecklistsCards(data)
	case "check_items":
		return db.UpsertCheckItems(data)
	case "custom-fields":
		return db.UpsertCustomFields(data)
	case "options":
		return db.UpsertOptions(data)
	case "enterprises":
		return db.UpsertEnterprises(data)
	case "admins":
		return db.UpsertAdmins(data)
	case "auditlog":
		return db.UpsertAuditlog(data)
	case "claimable_organizations":
		return db.UpsertClaimableOrganizations(data)
	case "enterprises_members":
		return db.UpsertEnterprisesMembers(data)
	case "enterprises_organizations":
		return db.UpsertEnterprisesOrganizations(data)
	case "pending_organizations":
		return db.UpsertPendingOrganizations(data)
	case "signup_url":
		return db.UpsertSignupUrl(data)
	case "enterprises_tokens":
		return db.UpsertEnterprisesTokens(data)
	case "transferrable":
		return db.UpsertTransferrable(data)
	case "lists_actions":
		return db.UpsertListsActions(data)
	case "archive_all_cards":
		return db.UpsertArchiveAllCards(data)
	case "lists_board":
		return db.UpsertListsBoard(data)
	case "lists_cards":
		return db.UpsertListsCards(data)
	case "closed":
		return db.UpsertClosed(data)
	case "id_board":
		return db.UpsertIdBoard(data)
	case "move_all_cards":
		return db.UpsertMoveAllCards(data)
	case "members_actions":
		return db.UpsertMembersActions(data)
	case "avatar":
		return db.UpsertAvatar(data)
	case "board_backgrounds":
		return db.UpsertBoardBackgrounds(data)
	case "members_board_stars":
		return db.UpsertMembersBoardStars(data)
	case "members_boards":
		return db.UpsertMembersBoards(data)
	case "boards_invited":
		return db.UpsertBoardsInvited(data)
	case "members_cards":
		return db.UpsertMembersCards(data)
	case "custom_board_backgrounds":
		return db.UpsertCustomBoardBackgrounds(data)
	case "custom_emoji":
		return db.UpsertCustomEmoji(data)
	case "custom_stickers":
		return db.UpsertCustomStickers(data)
	case "members_notifications":
		return db.UpsertMembersNotifications(data)
	case "notifications_channel_settings":
		return db.UpsertNotificationsChannelSettings(data)
	case "one_time_messages_dismissed":
		return db.UpsertOneTimeMessagesDismissed(data)
	case "members_organizations":
		return db.UpsertMembersOrganizations(data)
	case "organizations_invited":
		return db.UpsertOrganizationsInvited(data)
	case "saved_searches":
		return db.UpsertSavedSearches(data)
	case "members_tokens":
		return db.UpsertMembersTokens(data)
	case "notifications_board":
		return db.UpsertNotificationsBoard(data)
	case "notifications_card":
		return db.UpsertNotificationsCard(data)
	case "notifications_list":
		return db.UpsertNotificationsList(data)
	case "notifications_member":
		return db.UpsertNotificationsMember(data)
	case "notifications_member_creator":
		return db.UpsertNotificationsMemberCreator(data)
	case "notifications_organization":
		return db.UpsertNotificationsOrganization(data)
	case "unread":
		return db.UpsertUnread(data)
	case "organizations":
		return db.UpsertOrganizations(data)
	case "organizations_actions":
		return db.UpsertOrganizationsActions(data)
	case "organizations_boards":
		return db.UpsertOrganizationsBoards(data)
	case "organizations_exports":
		return db.UpsertOrganizationsExports(data)
	case "logo":
	...
	case "organizations_memberships":
		return db.UpsertOrganizationsMemberships(data)
	case "new_billable_guests":
		return db.UpsertNewBillableGuests(data)
	case "organizations_plugin_data":
		return db.UpsertOrganizationsPluginData(data)
	case "prefs":
		return db.UpsertPrefs(data)
	case "tags":
		return db.UpsertTags(data)
	case "plugins_compliance":
		return db.UpsertPluginsCompliance(data)
	case "listing":
		return db.UpsertListing(data)
	case "listings":
		return db.UpsertListings(data)
	case "tokens":
		return db.UpsertTokens(data)
	case "tokens_member":
		return db.UpsertTokensMember(data)
	case "tokens_webhooks":
		return db.UpsertTokensWebhooks(data)
	case "trello-calendar-search":
		return db.UpsertTrelloCalendarSearch(data)
	case "webhooks":
