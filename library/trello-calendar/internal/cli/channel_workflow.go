...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  trello-calendar-pp-cli workflow archive

  # Full re-archive (ignore previous sync state)
  trello-calendar-pp-cli workflow archive --full`,
...
func newWorkflowStatusCmd(flags *rootFlags) *cobra.Command {
  ...
  trello-calendar-pp-cli workflow status

  # Show status as JSON
  trello-calendar-pp-cli workflow status --json`,
		RunE: func(cmd *cobra.Command, args []string) error {
			if dbPath == "" {
				dbPath = defaultDBPath("trello-calendar-pp-cli")
			}
