...
but do not stop the import.`,
  ...
  ba-jobsuche-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  ba-jobsuche-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | ba-jobsuche-pp-cli import <resource> --input -`,
