...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "ba-jobsuche-pp-cli",
		Short: "Manage ba-jobsuche resources via the ba-jobsuche API",
		Long: `Manage ba-jobsuche resources via the ba-jobsuche API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'ba-jobsuche-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("ba-jobsuche-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'ba-jobsuche-pp-cli profile list')")
	...
	rootCmd.AddCommand(newBaJobsucheJobsPromotedCmd(flags))
...
func newVersionCliCmd() *cobra.Command {
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			fmt.Printf("ba-jobsuche-pp-cli %s\n", version)
		},
	}
}
