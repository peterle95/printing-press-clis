...
but do not stop the import.`,
  ...
  youtube-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  youtube-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | youtube-pp-cli import <resource> --input -`,
