...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "youtube-pp-cli",
		Short: "Manage youtube resources via the youtube API",
		Long: `Manage youtube resources via the youtube API.

Add --agent to any command for JSON output + non-interactive mode.
Run 'youtube-pp-cli doctor' to verify auth and connectivity.`,
		SilenceUsage: true,
		Version:      version,
	}
