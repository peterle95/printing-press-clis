...
func newYoutubeSearchListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example:     "  youtube-pp-cli youtube search-list --part example-value",
	...
	cmd.Flags().StringVar(&flagPart, "part", "", "The *part* parameter specifies a comma-separated list of one or more search resource properties that the API...")
